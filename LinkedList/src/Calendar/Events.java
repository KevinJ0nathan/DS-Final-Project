...
public class Events extends JPanel {
    ...
    public Events(LocalDate date, Database database, JPanel mainPanel) {
        ...
        // The events are temporarily stored in the LinkedList, it is filtered according to the date
        DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
        LinkedList<Event> events = database.getEvents(dateFormatter.format(date));
    ...
    public void populateEventList(LinkedList<Event> events) {
        list.removeAll();
